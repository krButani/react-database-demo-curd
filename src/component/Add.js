...
function Add() {
    ...
    const submitToServerWithFetch = () => {
        ...
        if(status == false) {
            fetch('https://jsonplaceholder.typicode.com/posts',{
                ...
                //console.log(data)
                navigate('/',{replace:true,state:{status: true, succ: "Post Added Successfully."}});
                return data;
            }).catch((error) => {
                console.error(error)
            });
    ...
    const submitToServerWithAxios = () => {
        ...
        if(status == false) {
            ...
            axios.post(
                `https://jsonplaceholder.typicode.com/posts`, { kpost })
                .then(res => {
                    console.log(res);
            ...
            <Box marginX={4}>
                <Grid container spacing={2}>
                    ...
                    <Grid xs={6} paddingY={3}>
                        <Item>
                            <Typography variant="h4" marginTop={2} marginX={4} gutterBottom>Add Post</Typography>
